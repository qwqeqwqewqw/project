        ...
        <div class="space-y-8">
          ...
          <div class="relative flex items-start">
            ...
            <div class="ml-8 bg-white p-6 rounded-lg shadow-md flex-1">
              ...
              <p class="text-gray-900">
                Cherilyn Monta was established with a vision to create
                exceptional real estate developments that blend quality with
          ...
          <div class="relative flex items-start">
            ...
            <div class="ml-8 bg-white p-6 rounded-lg shadow-md flex-1">
              ...
              <p class="text-gray-900">
                Built a reputation for delivering innovative real estate
                projects on time and within budget, establishing ourselves as
                trusted developers.
              </p>
            </div>
          </div>
          ...
          <div class="relative flex items-start">
            ...
            <div class="ml-8 bg-white p-6 rounded-lg shadow-md flex-1">
              ...
              <p class="text-gray-900">
                Expanded into hospitality with the development of Cherilyn Monta
                Resort, bringing luxury accommodation to the pristine Konkan
                coast.
              </p>
            </div>
          </div>
          ...
          <div class="relative flex items-start">
            <div
              class="flex-shrink-0 w-16 h-16 bg-gray-900 rounded-full flex items-center justify-center text-white font-bold text-sm"
            >
              Today
            </div>
            <div class="ml-8 bg-white p-6 rounded-lg shadow-md flex-1">
              ...
              <p class="text-gray-900">
                Recognized as one of Maharashtra's best coastal resorts,
                offering world-class amenities while preserving the natural
                beauty of Konkan.
              </p>
            </div>
          </div>
