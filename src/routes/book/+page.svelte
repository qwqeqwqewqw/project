...
<main class="min-h-screen pt-20 bg-freshCream">
  <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="grid lg:grid-cols-3 gap-8">
      ...
      <div class="lg:col-span-2 space-y-8">
        ...
        <div class="bg-cloudWhite rounded-2xl p-6 shadow-lg">
          <div class="flex items-center justify-between mb-4">
            <div class="flex items-center space-x-4">
              <h1 class="text-2xl sm:text-3xl font-bold text-midnight">{roomType}</h1>
        ...
        <!-- Overview -->
        <div class="bg-cloudWhite rounded-2xl p-6 shadow-lg">
          <h2 class="text-2xl font-bold text-midnight mb-4">Overview</h2>
        ...
        <!-- Room Amenities -->
        <div class="bg-cloudWhite rounded-2xl p-6 shadow-lg">
          <h2 class="text-2xl font-bold text-midnight mb-4">Room Amenities</h2>
        ...
        <!-- Booking Rules -->
        <div class="bg-cloudWhite rounded-2xl p-6 shadow-lg">
          <h2 class="text-2xl font-bold text-midnight mb-6">Booking Rules</h2>
          
          <div class="grid md:grid-cols-2 gap-8">
            <!-- Check In -->
            <div>
              <h3 class="text-xl font-semibold text-midnight mb-4">Check In</h3>
              <div class="space-y-3">
            ...
            <!-- Check Out -->
            <div>
              <h3 class="text-xl font-semibold text-midnight mb-4">Check Out</h3>
              <div class="space-y-3">
      ...
      <div class="lg:col-span-1">
        <div class="bg-cloudWhite rounded-2xl p-6 shadow-lg sticky top-24">
          <h2 class="text-2xl font-bold text-midnight mb-6">Book Room</h2>
